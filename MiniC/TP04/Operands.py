...
class Condition(Operand):
    """Condition, i.e. second operand of the add_instruction_cond_JUMP helper
    method.
...
class Renamer:
    ...
    def fresh(self, t: Temporary):
        new_t = self._pool.new_tmp()
        self._env[t] = new_t
        return new_t

    def replace(self, t: Temporary):
        return self._env.get(t)
